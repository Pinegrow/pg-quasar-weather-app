<template>
    <q-page class="flex column" :class="bgClass">
        ...
        <section class="col q-pt-lg q-px-md">
            <q-input v-model="searchText" borderless dark placeholder="Search" @keyup.enter="getWeatherBySearch">
        ...
        <template v-if="weatherData">
            <section class="col text-white text-center">
                ...
                <div class="text-h1 text-weight-thin q-my-lg relative-position"><span>{{ temp }}</span><span class="text-h4 relative-position degree">&deg;F</span>
                </div>
            </section>
        ...
        <template v-else>
            <section class="col column text-center text-white">
                <div class="col text-h2 text-weight-thin">Quasar<br/>Weather
                </div>
